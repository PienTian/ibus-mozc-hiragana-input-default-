...
void mozc::gui::GenericTableEditorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GenericTableEditorDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mozc::gui::GenericTableEditorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_mozc__gui__GenericTableEditorDialog.data,
    qt_meta_data_mozc__gui__GenericTableEditorDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
