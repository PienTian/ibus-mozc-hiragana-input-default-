...
public:
    ...
    void setupUi(QDialog *KeyBindingEditor)
    {
        if (KeyBindingEditor->objectName().isEmpty())
            KeyBindingEditor->setObjectName(QString::fromUtf8("KeyBindingEditor"));
        ...
        KeyBindingLineEdit->setObjectName(QString::fromUtf8("KeyBindingLineEdit"));
        ...
        KeyBindingEditorbuttonBox->setObjectName(QString::fromUtf8("KeyBindingEditorbuttonBox"));
        ...
        KeyBindingEditorLabel->setObjectName(QString::fromUtf8("KeyBindingEditorLabel"));
    ...
    {
        KeyBindingEditor->setWindowTitle(QCoreApplication::translate("KeyBindingEditor", "[ProductName] key binding editor", nullptr));
        KeyBindingEditorLabel->setText(QCoreApplication::translate("KeyBindingEditor", "Input key assignments:", nullptr));
    } // retranslateUi
