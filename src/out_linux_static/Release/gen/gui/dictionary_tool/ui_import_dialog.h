...
public:
    ...
    void setupUi(QDialog *ImportDialog)
    {
        ...
        dic_name_lineedit_->setObjectName(QString::fromUtf8("dic_name_lineedit_"));
        ...
        ime_combobox_->setObjectName(QString::fromUtf8("ime_combobox_"));
    ...
    {
        ImportDialog->setWindowTitle(QCoreApplication::translate("ImportDialog", "[ProductName] Dictionary Tool", nullptr));
        file_location_label_->setText(QCoreApplication::translate("ImportDialog", "File Location", nullptr));
        dic_name_label_->setText(QCoreApplication::translate("ImportDialog", "Dictionary Name", nullptr));
        ime_label_->setText(QCoreApplication::translate("ImportDialog", "Format", nullptr));
        encoding_label_->setText(QCoreApplication::translate("ImportDialog", "Encoding", nullptr));
        select_file_pushbutton_->setText(QCoreApplication::translate("ImportDialog", "Select file...", nullptr));
    } // retranslateUi
